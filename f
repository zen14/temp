...
========================================
  VARIJANTA A: IV=E(KSenc,SSC), MAC=SSC+pad(hdr)+DOs
========================================
SELECT AID SW=9000
--- BAC ---
EXT AUTH SW=9000
MAC OK: true
KS_ENC: D694A7D0B038E34632E3BA9BADD9080E
KS_MAC: 9D19C8234A469EE6F82CD39D13DF2558
SSC:    6F932B55422B0E22
BAC OK!
  APDU: 0CA4020C1587090133B9B5B9B812640C8E0849547F5FFF55297D00
  EF.COM SELECT -> SW=6988  SM crypto wrong

========================================
  VARIJANTA B: IV=E(KSenc,SSC), MAC=pad(SSC)+pad(hdr)+DOs
========================================
SELECT AID SW=9000
--- BAC ---
EXT AUTH SW=9000
MAC OK: true
KS_ENC: 8994400D7AE5F2C83B5E765DCE0B7616
KS_MAC: DA2AEF1361EC4F4A51294964EC258362
SSC:    9181A0C08F5D3F89
BAC OK!
  APDU: 0CA4020C15870901FF94ED15484595D58E08964BF8DA22173F8C00
  EF.COM SELECT -> SW=6988  SM crypto wrong

========================================
  VARIJANTA C: IV=zeros,         MAC=SSC+pad(hdr)+DOs
========================================
SELECT AID SW=9000
--- BAC ---
EXT AUTH SW=9000
MAC OK: true
KS_ENC: 25D0856E19B3ADDA86E68CFD9232461C
KS_MAC: FBEABFD0493E9B13296DA8B0CD4F682C
SSC:    6FDA7D455F3CF49A
BAC OK!
  APDU: 0CA4020C1587090157C5518D22E81C868E0832C0F85D7C3538B200
  EF.COM SELECT -> SW=9000  *** USPJEH! ***
  Varijanta C radi! Čitam sve...

--- EF.COM ---
  APDU: 0CA4020C1587090157C5518D22E81C868E088CBCE246C804F35300
  SELECT 011E SW=6988

--- DG1 MRZ ---
  APDU: 0CA4020C158709013783349F1CE63C418E08006FBFA01C339EF600
  SELECT 0101 SW=6985

--- DG11 Lični ---
  APDU: 0CA4020C15870901794DE58F7FBBA9F98E08D97749B9D751B57A00
  SELECT 010B SW=6985

--- DG12 Dok ---
  APDU: 0CA4020C15870901E1544B936A27419E8E08FFC15CF9A33A52DC00
  SELECT 010C SW=6985

--- DG2 Foto ---
  APDU: 0CA4020C1587090188931E3E286F59FE8E089C65FAAB56EA962300
  SELECT 0102 SW=6985

--- EF.SOD ---
  APDU: 0CA4020C15870901A41F36EC5424C6B98E08693F7F098224773800
  SELECT 011D SW=6985

--- DG15 ---
  APDU: 0CA4020C15870901289E85C932A4ED878E08FE9DD03BA3A8C6B600
  SELECT 010F SW=6985

========================================
  VARIJANTA E: READ BINARY sa SFI
  (bez prethodnog SELECT)
========================================
Re-SELECT AID SW=9000
--- BAC ---
EXT AUTH SW=9000
MAC OK: true
KS_ENC: DC76572AA12C1F4680C43E9B15257A04
KS_MAC: 5DAD020D1A0DA25EDF38ECB049D92685
SSC:    02A716AFC5785632
BAC OK!

  SM READ BINARY SFI=1E (EF.COM) P1=9E
    varC APDU: 0CB09E000D9701008E0869AA4348AF24028300
    varC -> SW=9000  OK
    *** USPJEH! data=872101B2B39E57E7899C2705823DC4B8B92FA97B2C2B88A3192A9152D7835CC9D5E89C990290008E08936CEE11D637ECCA
    varA APDU: 0CB09E000D9701008E08221218E9FE4941F000
    varA -> SW=6988  SM crypto wrong

  SM READ BINARY SFI=01 (DG1) P1=81
    varC APDU: 0CB081000D9701008E0882EA5A78B2D403E400
    varC -> SW=6985  Conditions not met
    varA APDU: 0CB081000D9701008E088BA4EF049355E6A900
    varA -> SW=6985  Conditions not met

  SM READ BINARY SFI=02 (DG2) P1=82
    varC APDU: 0CB082000D9701008E08C9971CBEC4AB0A5C00
    varC -> SW=6985  Conditions not met
    varA APDU: 0CB082000D9701008E08491CCE424FBE7FD300
    varA -> SW=6985  Conditions not met

  SM READ BINARY SFI=0B (DG11) P1=8B
    varC APDU: 0CB08B000D9701008E088FD50A041D26D72600
    varC -> SW=6985  Conditions not met
    varA APDU: 0CB08B000D9701008E085771E7C4AB5763D000
    varA -> SW=6985  Conditions not met

  SM READ BINARY SFI=0C (DG12) P1=8C
    varC APDU: 0CB08C000D9701008E080742E53BAB0E879300
    varC -> SW=6985  Conditions not met
    varA APDU: 0CB08C000D9701008E08C2BF153C56F9917700
    varA -> SW=6985  Conditions not met

  SM READ BINARY SFI=1D (EF.SOD) P1=9D
    varC APDU: 0CB09D000D9701008E08902E47FBDE47247A00
    varC -> SW=6985  Conditions not met
    varA APDU: 0CB09D000D9701008E08696571D9FECC832700
    varA -> SW=6985  Conditions not met

  SM READ BINARY SFI=0F (DG15) P1=8F
    varC APDU: 0CB08F000D9701008E08FB5F8738D9FA4A1700
    varC -> SW=6985  Conditions not met
    varA APDU: 0CB08F000D9701008E08B3660730BBD2A43600
    varA -> SW=6985  Conditions not met

========================================
  VARIJANTA F: SELECT bez DO'87 (samo MAC)
========================================
Re-SELECT AID SW=9000
--- BAC ---
EXT AUTH SW=9000
MAC OK: true
KS_ENC: D007D594B5E92929CD3DE5858A4F58F8
KS_MAC: F752620107B35DD6B32576624AC88AB0
SSC:    5A67E8DA5A054029
BAC OK!
  SM SELECT SFI=1E APDU: 0CA4021E0A8E0869CE9E8B79229B3500
  SW=6988  SM crypto wrong
  SM SELECT SFI=01 APDU: 0CA402010A8E0890DE19D4A01D5CA300
  SW=6985  Conditions not met
  SM SELECT SFI=02 APDU: 0CA402020A8E0872D7A630E3DECFBF00
  SW=6985  Conditions not met
  SM SELECT SFI=0B APDU: 0CA4020B0A8E08967B64882D04DDF400
  SW=6985  Conditions not met
